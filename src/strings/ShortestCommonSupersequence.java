...
public class ShortestCommonSupersequence {
    ...
    //From the explanation above, we can see that characters of lcs need to be covered only once.
    // Therefore, the length of the shortest Common
    // supersequence = "n + m -k", where (n and m are lengths of S1 and S2, and k is the length of the lcs string).
